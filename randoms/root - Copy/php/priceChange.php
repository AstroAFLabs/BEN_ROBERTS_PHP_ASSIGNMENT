...
<label for="price"></label><input type="text" id="price" name="price"  min="20" max="200" value="<?PHP echo $productId;?>"/><span class="error">*<?php echo $errMessagePrice;?>></span></br></br>
